...
export default function Navbar() {
  return (
    <header className="fixed w-full z-30 bg-zinc-900/5 backdrop-blur-md border-b border-border/40">
      <div className="w-full">
        <nav className=" relative flex md:grid md:grid-cols-3 items-center py-4 px-4 xl:px-0 max-w-7xl mx-auto">
          <Link
            href="/"
          ...
          <Link
            href="https://github.com/guifariadev/BIT_ELEMENTS"
            target="_blank"
