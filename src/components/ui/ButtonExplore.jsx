//  From Uiverse.io by nathAd17 with modifications

export default function ButtonExplore( {text} ) {
  return (
    <button className="relative group border-none bg-transparent p-0 outline-none cursor-pointer uppercase font-light">
      ...
      <div className="relative flex items-center justify-between py-3 px-6 text-sm md:text-lg text-white rounded-lg transform -translate-y-1 button-color gap-3 transition duration-[600ms] ease-[cubic-bezier(0.3,0.7,0.4,1)] group-hover:-translate-y-1.5 group-hover:duration-[250ms] group-active:-translate-y-0.5 brightness-100 group-hover:brightness-110">
